...
CREATE STORAGE INTEGRATION azure_integration
  ...
  STORAGE_ALLOWED_LOCATIONS = ('azure://your-account.blob.core.windows.net/your-container/path/data', 'azure://your-account.blob.core.windows.net/your-container/path/data');
